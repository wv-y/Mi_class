package com.example.mi_class.stickydotslib.view;
...
import com.example.mi_class.stickydotslib.utils.GeometryUtil;
...
//                防止误操作
    ...
    private void updateManagerView(float x, float y) {
        ...
        mParams.y=(int)(y-mDragViewWidth*4);

        Log.d("MMMMXP",String.valueOf(mDragCanterPoint.x));
        Log.d("MMMMX",String.valueOf(mParams.x));

        Log.d("MMMMY",String.valueOf(mDragCanterPoint.y));

        Log.d("MMMMRIDUS",String.valueOf(mDragRadius));
        Log.d("MMMMVH",String.valueOf(mDragViewHeight));
